...
public class EmployeeDAO {
    ...
    //FOR DEPARTMENT NAME
   // private static final String SELECT_DEPARTMENT_NAME = "SELECT d.department_id FROM employees e JOIN departments d ON e.department_id = d.department_id";
    ...
    private Employee toEmployee(ResultSet row) throws SQLException {
        ...
        employee.setDepartmentId(row.getInt(6));
        employee.setDepartmentName(row.getString(7));
        employee.setJobId(row.getString(8));
        return employee;
    }
}
